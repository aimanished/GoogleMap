package sg.edu.rp.webservices.googlemap;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2 = (Button) findViewById(R.id.terrain);
        btn3 = (Button) findViewById(R.id.satelite);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (map != null) {
                    ...
                    LatLng poi_CausewayPoint = new LatLng(1.436065,103.412343);
